        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1">
            ...
            <p className="text-gray-400 text-sm">
              Connecting passionate learners with expert teachers worldwide.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-gray-400">
              <li><Link to="/browse" className="hover:text-white">Browse Teachers</Link></li>
              <li><Link to="/signup" className="hover:text-white">Become a Teacher</Link></li>
